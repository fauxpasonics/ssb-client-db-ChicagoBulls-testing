CREATE TABLE [stg].[FILE__TM_Archive_Bulls_2013_note]
(
...
GO
ALTER TABLE [stg].[FILE__TM_Archive_Bulls_2013_note] ADD CONSTRAINT [PK__FILE__TM__C4EA2445CD1CD63F] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
