CREATE TABLE [stg].[FILE__TM_Archive_Bulls_2014_note]
(
...
GO
ALTER TABLE [stg].[FILE__TM_Archive_Bulls_2014_note] ADD CONSTRAINT [PK__FILE__TM__C4EA2445EE407D73] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
