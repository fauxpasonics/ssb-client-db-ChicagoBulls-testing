CREATE TABLE [stg].[FILE__TM_Archive_Bulls_2016_note]
(
...
GO
ALTER TABLE [stg].[FILE__TM_Archive_Bulls_2016_note] ADD CONSTRAINT [PK__FILE__TM__C4EA2445C526C6A5] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
