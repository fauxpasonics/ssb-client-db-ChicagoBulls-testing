CREATE TABLE [stg].[FILE__TM_Archive_Bulls_2012_note]
(
...
GO
ALTER TABLE [stg].[FILE__TM_Archive_Bulls_2012_note] ADD CONSTRAINT [PK__FILE__TM__C4EA24450A1F6652] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
