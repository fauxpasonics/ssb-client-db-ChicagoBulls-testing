CREATE TABLE [stg].[FILE__TM_Archive_Bulls_2015_note]
(
...
GO
ALTER TABLE [stg].[FILE__TM_Archive_Bulls_2015_note] ADD CONSTRAINT [PK__FILE__TM__C4EA244579083A14] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
